...
If you are attending the **Scale complete ML development with Amazon SageMaker Studio** run by AWS, the AWS event facilitator provides you access to a temporary AWS account preconfigured for this workshop. Proceed to <a href="./01_build_and_train/01_build_and_train.ipynb">**Module 1: Build and train models**</a>.
