...
- <a href="05_API_Gateway_and_Lambda/">**Module 05**</a> - Building a REST API using Amazon API Gateway and implementing an AWS Lambda function that will invoke the Amazon SageMaker endpoint for inference.
